                        ...
                        <div class="m-widget1">
                            ...
                            <form class="m-section m--margin-bottom-5 js-form" method="post" action="">
                                    ...
                                    <div class="form-group field-task-label_group_id required">
                                        <div class="input-group">
                                            <input type="text" id="address"
                                                   ...
                                                   value="<?= $task->contract_address ?>" disabled="disabled">
                                            <div class="input-group-append">
                                                <span class="input-group-text">
                                                  <a href="<?= \common\domain\ethereum\Etherscan::addressUrl($task->contract_address) ?>"
                                                     target="_blank"><?= Yii::t('app', 'View in Etherscan') ?></a>
                                                </span>
                                            </div>
                                        </div>
                                ...
                                <div class="form-group m-form__group">
                                    ...
                                    <div class="form-group field-task-label_group_id required">
                                        <input type="hidden" id="tokensValue"
                                               class="form-control m-input js-tokens-value" name="tokensValue"
                                               value="<?= $tokensValue ?>" disabled="disabled">
                                        <input type="text" id="tokensValueFormatted" class="form-control m-input"
                                               name="tokensValueFormatted" value="<?= bcdiv($tokensValue,
                                            '1000000000000000000',
                                            6
                                        ); ?>" disabled="disabled">
                                        <div class="help-block"></div>
                                ...
                                <div class="form-group m-form__group m--padding-top-20">
                                    <button type="submit"
                                            class="btn btn-info m-btn--pill m-btn--air pull-right js-btn-transfer"
                                            disabled="disabled"><?= Yii::t('app', 'Send tokens') ?></button>
